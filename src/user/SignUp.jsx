...
const SignUp = () => {
  return (
    <div className='w-full flex items-center justify-center'>
      <section className='w-full md:w-1/2 h-auto flex flex-col md:flex-row items-center justify-center gap-4'>
        ...
        <div className='w-full md:w-3/4 p-4 rounded-lg flex flex-col items-center justify-center gap-3 bg-gray-50'>
