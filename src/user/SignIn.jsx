      ...
      <section className='w-full lg:w-1/2 h-auto flex flex-col md:flex-row items-center justify-center gap-4'>
        ...
        <form onSubmit={handleSubmit} className='w-full p-4 rounded-lg flex flex-col items-center justify-center gap-3 bg-gray-50'>
          <div className=' flex flex-col items-start justify-start gap-2 w-full md:w-3/5'>
            ...
            <input required type="email" name='email' id='email' className='w-full outline-none border-2 px-3 p-1 rounded-md' onChange={handleChange} value={user.email} />
          </div>
          <div className=' flex flex-col items-start justify-start gap-2 w-full md:w-3/5'>
            <label htmlFor="password">password</label>
            <input required type="text" name='password' id='password' className='w-full outline-none border-2 px-3 p-1 rounded-md' onChange={handleChange} value={user.password} />
          </div>
